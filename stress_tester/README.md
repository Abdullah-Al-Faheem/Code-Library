...
- [Codeforces 327A – Flipping Game](https://codeforces.com/problemset/problem/327/A)
    

The following resources were helpful while building this stress tester:

1. [Ali Ibrahim – Stress Testing Guide](https://ali-ibrahim137.github.io/competitive/programming/2020/08/23/Stress-Testing.html)
    
2. [Adnan Zawad Toky – YT Tutorial](https://youtu.be/1jcBJN05StQ)
